	...
	<div class="page-header">
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Admin Dashboard <small>Hello, Victoria!</small></h4>
			</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="active"><a href="/admin/home"><i class="icon-home4"></i> <span>Admin Dashboard</span></a></li>
					...
					<div class="col-lg-8">
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">All AfriHow Users</h5>
								<div class="heading-elements">
									<ul class="icons-list">
							...
							<table class="table datatable-scroll-y" width="100%">
								...
								<tbody>	
									<tr>
										<td>Julius Olajumoke</td>
										<td>juliusolajumokecoder@gmail.com</td>
	...
	<div class="navbar navbar-default navbar-fixed-bottom footer">
		...
		<div class="navbar-collapse collapse" id="footer">
			<div class="navbar-text">
				&copy; <?php echo date('Y'); ?> <a href="#" class="navbar-link">AfriHow Admin Management Platform</a> by <a href="http://themeforest.net/user/Kopyov" class="navbar-link" target="_blank">AfriHowTech Solutions</a>
			</div>
