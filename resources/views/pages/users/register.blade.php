            ...
            <div class="col-md-6">
                <div class="register_panel">
                    <div class="text-center">
                        ...
                        <!--<div class="content-divider"><span class="text-muted">Or Sign Up With</span></div>
                        <div class="clearfix"></div>-->
                        ...
                        <div class="text-muted mt-1"><p>By continuing, you confirm that you've read and agreed to our <a href="/terms" class="text-decorate-none">Terms & Privacy Policies</a> </p></div>
                    </div>
                </div>
            </div>
        </div>
