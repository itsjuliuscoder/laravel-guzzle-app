        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="/publisher/my-subject"><i class="fa fa-circle-o"></i> My Subjects</a></li>
          ...
          <li><a href="/users/send_feedback"><i class="fa fa-circle-o text-red"></i> <span>Send Feedback</span></a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              @if($_COOKIE['profile_img'] == "upload an image")
                <img src="../dist/img/user2-160x160.jpg" class="profile-user-img img-responsive img-circle" alt="User Image">
              @else
                  <img src="{{$_COOKIE['profile_img']}}" alt="{{$_COOKIE['fullname']}} . Profile Picture" class="profile-user-img img-responsive img-circle">
              @endif
              <h3 class="profile-username text-center">{{$_COOKIE['fullname']}}</h3>

              <p class="text-muted text-center">Software Engineer</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Subjects</b> <a class="pull-right">0</a>
                </li>
                <li class="list-group-item">
                  <b>Topics</b> <a class="pull-right">0</a>
                </li>
                <li class="list-group-item">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-book margin-r-5"></i> Know me</strong>
