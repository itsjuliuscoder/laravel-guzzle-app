            ...
            <div class="col-md-6">
                <div class="login_info">
                    <div class="text-center">
                       <img src="img/login_img.jpg" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="text-center">
                        ...
                        <form class="register-form" action="/login_user" method="POST">
                            ...
                            <div class="input-container">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" placeholder="Email Address" class="input-field">
                            </div>
                            ...
                            <div class="input-container">
                                ...
                                <input type="password" name="password" value="{{ old('password') }}" placeholder="Password" class="input-field">
                            </div>
                        ...
                        <p class="mt-1"><a href="/reset-password">Forgot your password?</a></p>
                    </div>
                </div>
            </div>
        </div>
