                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col related box-effect1">
                            <div class="write_article">
                              <form action="{{ url('publisher/update_subject') }}/{{$body['_id']}}" class="col-12 settings mt-4" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                <input type="hidden" name="_method" value="PUT">
                                  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group inner-addon left-addon">
                                      ...
                                      <input type="text" name="subject_title" value="{{$body['subject_title']}}" required="" data-toggle="tooltip" title="Update Your Fullname!" class="border-green border-lg" id="" placeholder="">
                                      <label alt='Enter New Fullname' placeholder='Your Fullname'></label> 
                                    </div>
                                    <label for=""></label>
                                    <div class="form-group inner-addon left-addon">
                                      <!--<i class="fa fa-list-alt"></i>-->
                                      <input type="text" name="subject_description" value="{{$body['subject_description']}}" required="" data-toggle="tooltip" title="Update Your About Description" class=" border-green border-lg" id="" placeholder="">
                                      <label alt='Enter About' placeholder='About You'></label> 
                                    </div>
                                    <label for=""></label>
                                    <div class="form-group inner-addon left-addon">
                                      <!--<i class="fa fa-list-alt"></i>-->
                                      <input type="text" name="subject_url" value="{{$body['subject_url']}}" required="" data-toggle="tooltip" title="Update Your About Description" class=" border-green border-lg" id="" placeholder="">
                                      <label alt='Enter About' placeholder='About You'></label> 
                                    </div>
                                  </div>
                                </div>
