...
<section class="home-slider owl-carousel">
    <div class="slider-item">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Digitizing Learning in Africa</h1>
                <p class="mb-4 mb-md-5 sub-p" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We believe in the Africa dream, join us as we make learning free, accessible and reliable.</p>
                <p><a href="#" class="btn btn-primary p-3 px-xl-5 py-xl-3">Get started</a> 
                </p>
                </div>
    ...
    <div class="slider-item">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Let Learn It</h1>
                <p class="mb-4 mb-md-5 sub-p" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We believe in the Africa dream, join us as we make learning free, accessible and reliable.</p>
                <p><a href="#" class="btn btn-primary p-3 px-xl-5 py-xl-3">Get started</a> 
                </p>
                </div>
                <div class="col-md-6 ftco-animate">
                    <img src="../img/slider/planting.png" class="img-fluid" alt="Slider Image 2">
                </div>
            </div>
        </div>
    </div>
...
<section id="section">
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 ftco-animate">
                        <div class="subj_col">
                            ...
                            <div class="subj_col_main">
                                    <img src="../img/code.jpeg" alt="Slatecube" class="img-fluid">
                            </div>
                ...
                <div class="col-md-3 ftco-animate">
                        <div class="subj_col">
                            ...
                            <div class="subj_col_main">
                                    <img src="../img/mobile.jpeg" class="img-fluid" alt="">
                            </div>
                            <div class="subj_col_list">
                                    <ul>
                                        <li><a href="#">How to treat the girl child&nbsp;<span class="fa fa-chevron-right"></span> </a> </li>
                ...
                <div class="col-md-3 ftco-animate">
                        <div class="subj_col">
                            ...
                            <div class="subj_col_main">
                                <img src="../img/relationship.jpeg" class="img-fluid" alt="">
                            </div>
                            <div class="subj_col_list">
                                    <ul>
                                        <li><a href="#">How to treat the girl child&nbsp;<span class="fa fa-chevron-right"></span> </a> </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                            <div class="subj_col">
                                ...
                                <div class="subj_col_main">
                                        <img src="../img/puff.jpeg" class="img-fluid" alt="">
                                </div>
                                <div class="subj_col_list">
                                        <ul>
                                            <li><a href="#">How to treat the girl child&nbsp;<span class="fa fa-chevron-right"></span> </a> </li>
        ...
        <div class="get_started mt-2">
            <h2>WE WANT TO LEARN</h2>
            <div class="row">
                <div class="col-md-5">
                    <div class="get_started_left">
                        
                        <img src="../img/learn.jpg" alt="Sign Up" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-7">
            ...
            <div class="row">
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="most_read_item mt-2">
                        <div class="most_read_item_img">
                            <img src="../img/map_02.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="most_read_body">
                            <a href=""><h4>BUILDING A PLATFORM FOR LUCK</h4></a>
                        </div>
