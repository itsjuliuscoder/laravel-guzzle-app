...
<div class="abt-banner">
    <div class="abt-text">
    <h3>LATEST</h3>
    <p>Our mission at Afrihow is to making learning across various sectors, accessible to Africa's growing population.</p>
    </div>
</div>
<!-- breadcrumbs goes here -->
<div class="banner-btm">
    <div class="container-fluid">
    <p><a href="index.php">Home</a> || <span class="text-muted">Latest</span></p>
    </div>
</div>
<!-- // end of breadcrumbs -->
<!-- // end of about banner -->
