                        ...
                        <div class="write_article">
							<form action="{{ url('publisher/create_article') }}" class="col-12 mt-4" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for=""></label>
									<select name="topic" data-toggle="tooltip" data-placement="right" title="Select a Topic">
										<option value="">Title of Topic</option>
										<option value=""></option>
										<option value=""></option>
									</select>
								</div>
...
</script>                     <img src="../images/avatar/avatar2.jpg" alt="">
                                </div>
