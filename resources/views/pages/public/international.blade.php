...
<div class="abt-banner">
    <div class="about-bar"> 
        ...
        <p>An organization's ability to learn, and translate that learning into action rapidly, is the ultimate competitive advantage.</p>
        <h6><strong> - Jack Welch</strong></h6>
    </div>
</div>
<!-- // end of about banner -->
@endsection
